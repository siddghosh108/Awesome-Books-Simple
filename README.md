...
-In this project, will build a basic website that allows users to add/remove books from a list.Achieve that by using JavaScript objects and arrays.Dynamically modify the DOM and add basic events.
...
-  git clone https://github.com/siddghosh108/Awesome-Books-Simple.git
